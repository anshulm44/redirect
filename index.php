...
define('CAMPAIGN_ID', "79258b2ee20e6504efc2c8113f1cb753");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'a49a6b72376739a51385ea039b91a85f');
define('MP_PARAM_NAME', '_ol__id');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', 'c36250de2ec75cab5bcc079589cf17ac');
define('CHECK_MCPROXY_VALUE', '5637d8bc30b56d75d807c66217954b2f98a3235f782a078737d908df906d4ba6');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '19339.3');
